...
const connect = async () => {
    await mongoose.connect('mongodb+srv://Teli:Teli123456789@swapi.zqt9e.mongodb.net/swapi?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true })
